package com.gdgocbu.tabulation.backend.exceptions.handlers;

import com.gdgocbu.tabulation.backend.exceptions.common.ErrorCode;
import com.gdgocbu.tabulation.backend.exceptions.common.ErrorResponse;
import com.gdgocbu.tabulation.backend.exceptions.common.SQLState;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleAccessDeniedException(
        ...
        String message = "You are not allowed to do that! XD";
